...
import { useDispatch } from 'react-redux'; // импортируем из библеотеки react-redux useSelector, useDispatch
import { setTypeSort,  Sort as SortType} from '../redux/slices/filterSlice';
...
const Sort: React.FC<SortPopupProps> = React.memo(
   ({ value }) => {
